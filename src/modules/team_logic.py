    ...
    try:
        ...
        if teams_with_3 and teams_with_4:
            for team_idx_4 in teams_with_4:
                # Verificar se este time tem jogadores da categoria A
                a_players = [p for p in teams[team_idx_4] if 0 <= p["handicap"] <= 10]
                if a_players:
                    ...
                    for team_idx_3 in teams_with_3:
                        if not any(0 <= p["handicap"] <= 10 for p in teams[team_idx_3]):
                            # Mover o jogador A para o time de 3
                            player = a_players[0]
                            teams[team_idx_4].remove(player)
                            teams[team_idx_3].append(player)
                            # Atualizar handicaps
                            team_weighted_handicaps[team_idx_3] += player["weighted_handicap"]
                            team_weighted_handicaps[team_idx_4] -= player["weighted_handicap"]
                            ...
                            if non_a_players:
                                ...
                                teams[team_idx_4].append(player_to_move)
                                # Atualizar handicaps
                                team_weighted_handicaps[team_idx_4] += player_to_move["weighted_handicap"]
